...
namespace Man_hinh_main_sub {
    ...
    public partial class QLSV : global::System.Data.DataSet {
        ...
        public partial class SINHVIENDataTable : global::System.Data.TypedTableBase<SINHVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SINHVIENRow AddSINHVIENRow(string MaSV, string HoSV, string TenSV, bool Phai, System.DateTime NgaySinh, string NoiSinh, string Quan, KHOARow parentKHOARowByFK_SINHVIEN_KHOA, double HocBong) {
...
namespace Man_hinh_main_sub.QLSVTableAdapters {
...
SELECT MaSV, MaMH, Diem FROM KETQUA WHERE (MaMH = @MaMH) AND (MaSV = @MaSV)";
        ...
        public virtual QLSV.KETQUADataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLSV.KETQUADataTable dataTable = new QLSV.KETQUADataTable(true);
    ...
    public partial class SINHVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[SINHVIEN] ([MaSV], [HoSV], [TenSV], [Phai], [NgaySinh], [NoiSinh], [Quan], [MaKH], [HocBong]) VALUES (@MaSV, @HoSV, @TenSV, @Phai, @NgaySinh, @NoiSinh, @Quan, @MaKH, @HocBong);
SELECT MaSV, HoSV, TenSV, Phai, NgaySinh, NoiSinh, Quan, MaKH, HocBong FROM SINHVIEN WHERE (MaSV = @MaSV)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MaSV", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MaSV", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SINHVIEN] SET [MaSV] = @MaSV, [HoSV] = @HoSV, [TenSV] = @TenSV, [Phai] = @Phai, [NgaySinh] = @NgaySinh, [NoiSinh] = @NoiSinh, [Quan] = @Quan, [MaKH] = @MaKH, [HocBong] = @HocBong WHERE (([MaSV] = @Original_MaSV) AND ((@IsNull_HoSV = 1 AND [HoSV] IS NULL) OR ([HoSV] = @Original_HoSV)) AND ((@IsNull_TenSV = 1 AND [TenSV] IS NULL) OR ([TenSV] = @Original_TenSV)) AND ([Phai] = @Original_Phai) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_NoiSinh = 1 AND [NoiSinh] IS NULL) OR ([NoiSinh] = @Original_NoiSinh)) AND ((@IsNull_Quan = 1 AND [Quan] IS NULL) OR ([Quan] = @Original_Quan)) AND ((@IsNull_MaKH = 1 AND [MaKH] IS NULL) OR ([MaKH] = @Original_MaKH)) AND ((@IsNull_HocBong = 1 AND [HocBong] IS NULL) OR ([HocBong] = @Original_HocBong)));
SELECT MaSV, HoSV, TenSV, Phai, NgaySinh, NoiSinh, Quan, MaKH, HocBong FROM SINHVIEN WHERE (MaSV = @MaSV)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MaSV", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MaSV", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT MaSV, HoSV, TenSV, Phai, NgaySinh, NoiSinh, Quan, MaKH, HocBong FROM dbo.S" +
                "INHVIEN";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Delete(string Original_MaSV, string Original_HoSV, string Original_TenSV, bool Original_Phai, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_NoiSinh, string Original_Quan, string Original_MaKH, global::System.Nullable<double> Original_HocBong) {
            ...
            if ((Original_Quan == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[11].Value = ((string)(Original_Quan));
            }
            ...
            if ((Original_HocBong.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[15].Value = ((double)(Original_HocBong.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Original_Quan == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_Quan));
            }
            if ((Original_MaKH == null)) {
            ...
            if ((Original_HocBong.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((double)(Original_HocBong.Value));
            }
            else {
